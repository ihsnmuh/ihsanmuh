      ...
      <div className={cn(
        ...
        <div className='flex flex-col gap-4'>
          ...
          <p className='text-xs text-slate-900 dark:text-slate-200'>
            © 2023,{' '}
            <UnderlineLink className='text-slate-600/70 dark:text-white/70' href='/'>
              Muhammad Ihsan
            </UnderlineLink>  
            . All rights reserved.
          </p>
        ...
        <div>
          <p className='text-sm font-semibold underline underline-offset-2 decoration-primary-400'>Reach me out</p>
          <div className='flex justify-end gap-2 mt-2'>
            <Link href='mailto:muhaammadihsan@gmail.com'>
