import { Activity, BookOpen, Camera, Sparkles } from 'lucide-react';
...
import { useStravaActivities } from '@/helpers/useStravaActivities';
              ...
              <div>
                <div className='mb-5'>
                  ...
                  <p className='text-xs text-slate-400 dark:text-slate-500 mt-0.5'>
                    Showing latest {displayedActivities.length} activities
                  </p>
                </div>
